...
htmlhelp_basename = "pywincffidoc"
...
latex_documents = [
  (master_doc, "PyWinCFFI.tex", "PyWinCFFI Documentation",
   "Oliver Palmer", "manual"),
]
...
man_pages = [
    (master_doc, "pywincffi", "PyWinCFFI Documentation",
     [author], 1)
]
