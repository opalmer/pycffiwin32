...
%PYTHON%\Scripts\pylint.exe C:\project\pywincffi --reports no --disabled %DISABLED_PYWINCFFI_CHECKS% || EXIT 1
%PYTHON%\Scripts\pylint.exe C:\project\tests --reports no --disabled %DISABLED_TEST_CHECKS% || EXIT 1
