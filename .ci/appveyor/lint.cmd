%WITH_COMPILER% %PYTHON%\Scripts\pep8.exe C:\project\pywincffi C:\project\tests || EXIT 1
...
%WITH_COMPILER% %PYTHON%\Scripts\pylint.exe C:\project\pywincffi --reports no --disable %DISABLED_PYWINCFFI_CHECKS% || EXIT 1
%WITH_COMPILER% %PYTHON%\Scripts\pylint.exe C:\project\tests --reports no --disable %DISABLED_TEST_CHECKS% || EXIT 1
